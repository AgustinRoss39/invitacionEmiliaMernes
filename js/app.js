...
function fitNameTitles() {
  fitTextToContainer($("#loader-title"), 62, 28);
  fitTextToContainer($("#guest-name"), 74, 30);
}
...
function populateInvitation() {
  ...
  if (portrait) {
    ...
    portrait.alt = invitation.name ? `Foto de ${invitation.name}` : "Foto de la cumpleañera";
  }
...
function updateCountdown() {
  ...
  if (now >= end) {
    finishCountdown("¡Gracias por venir a festejar! 💖");
    return;
  }
